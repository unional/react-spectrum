...
import {useProvider} from '@react-spectrum/provider'; // see https://github.com/storybookjs/storybook/issues/8426#issuecomment-669021940
...
export const CardGridNoPreview = {
  render: (props: SpectrumCardProps) => {
    let {scale} = useProvider();
    return (
      <div
...
export const CardWaterfallNoPreview = {
  render: (props: SpectrumCardProps) => (
    <div
      style={{
        width: '100%',
...
WithColorfulIllustration.decorators = [
  (Story) => (
    <div>
...
WithColorfulIllustratedMessage.args = {
  children: (
    <>
      <IllustratedMessage>
        <ColorfulIllustration />
...
WithColorfulIllustratedMessage.decorators = [
  (Story) => (
    <div>
      <div>
        {
          'does not work right now, Illustrated Message messes with the styles and has some other interference. We may not even want to support it this way.'
        }
      </div>
      <Story />
    </div>
...
Selected.args = {...Default.args}; // actually use Illustration???
